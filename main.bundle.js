...
module.exports = "<nav>\n  <a routerLink=\"/alerts\" routerLinkActive=\"active\">Alerts</a>\n  <a routerLink=\"/line-chart\" routerLinkActive=\"active\">LineChart</a>\n  <a routerLink=\"/calorie\" routerLinkActive=\"active\">Calorie</a>\n</nav>\n<router-outlet></router-outlet>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__alerts_alerts_component__ = __webpack_require__("../../../../../src/app/alerts/alerts.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__home_home_component__ = __webpack_require__("../../../../../src/app/home/home.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__line_chart_line_chart_component__ = __webpack_require__("../../../../../src/app/line-chart/line-chart.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__calorie_calorie_component__ = __webpack_require__("../../../../../src/app/calorie/calorie.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__alerts_alerts_component__["a" /* AlertsComponent */],
                __WEBPACK_IMPORTED_MODULE_9__home_home_component__["a" /* HomeComponent */],
                __WEBPACK_IMPORTED_MODULE_10__line_chart_line_chart_component__["a" /* LineChartComponent */],
                __WEBPACK_IMPORTED_MODULE_11__page_not_found_page_not_found_component__["a" /* PageNotFoundComponent */],
                __WEBPACK_IMPORTED_MODULE_12__calorie_calorie_component__["a" /* CalorieComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["a" /* BrowserModule */],
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* RouterModule */].forRoot([
                    { path: '', component: __WEBPACK_IMPORTED_MODULE_9__home_home_component__["a" /* HomeComponent */] },
                    { path: 'alerts', component: __WEBPACK_IMPORTED_MODULE_8__alerts_alerts_component__["a" /* AlertsComponent */] },
                    { path: 'line-chart', component: __WEBPACK_IMPORTED_MODULE_10__line_chart_line_chart_component__["a" /* LineChartComponent */] },
                    { path: 'calorie', component: __WEBPACK_IMPORTED_MODULE_12__calorie_calorie_component__["a" /* CalorieComponent */] },
...
/***/ "../../../../../src/app/calorie/calorie.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/calorie/calorie.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"row\">\n  <div class=\"col-md-12\">\n    <p></p>\n    <button (click)=\"set(0)\">Reset</button>\n    <button (click)=\"set(1)\">Test 1</button>\n    <button (click)=\"set(2)\">Test 2</button>\n    <button (click)=\"set(3)\">Test 3</button>\n    <button (click)=\"set(4)\">Test 4</button>\n    <p></p>\n    <input [(ngModel)]=\"dateFilter.after\" placeholder=\"after\">\n    <input [(ngModel)]=\"dateFilter.before\" placeholder=\"before\">\n    <button (click)=\"filterProcess()\">Filter</button>\n    <p></p>\n    <div style=\"display: block;\">\n    <canvas baseChart width=\"1500\" height=\"580\" *ngIf=\"initialized\"\n                [datasets]=\"lineChartData\"\n                [labels]=\"lineChartLabels\"\n                [options]=\"lineChartOptions\"\n                [colors]=\"lineChartColors\"\n                [legend]=\"lineChartLegend\"\n                [chartType]=\"lineChartType\"></canvas>\n    </div>\n    <div class=\"col-md-6\" *ngIf=\"initialized == false\">\n      <div class=\"well\">\n        <div>Loading...</div>\n        <div class=\"progress\">\n          <div class=\"progress-bar progress-bar-striped active\" role=\"progressbar\" aria-valuenow=\"100\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: 100%\">\n            <span class=\"sr-only\">100% Complete</span>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/calorie/calorie.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CalorieComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var CalorieComponent = /** @class */ (function () {
    function CalorieComponent(http) {
        var _this = this;
        this.http = http;
        this.url = 'https://spreadsheets.google.com/feeds/list/1EXEiX0Mh2vbD0JF7gyQl5ff3xMhBRCz0kMSNVcwDsyo/1/public/values?alt=json';
        ...
        this.dataProcess = function (data) {
            _this.dataScoure.label.length = 0;
            _this.dataScoure.data[0].data.length = 0;
            for (var _i = 0, _a = data.json().feed.entry; _i < _a.length; _i++) {
                var entry = _a[_i];
                var date = entry['gsx$date']['$t'];
                var bodyweight = entry['gsx$bodyweight']['$t'];
                var today = __WEBPACK_IMPORTED_MODULE_3_moment__().format('YYYY-MM-DD');
                if (date !== "" && bodyweight !== "" && date <= today) {
                    _this.dataScoure.label.unshift(date);
                    _this.dataScoure.data[0].data.unshift(bodyweight);
                }
            }
            _this.lineChartLabels = _this.dataScoure.label.slice();
            _this.lineChartData = JSON.parse(JSON.stringify(_this.dataScoure.data));
            _this.initialized = true;
        };
    }
    CalorieComponent.prototype.ngOnInit = function () {
    };
    CalorieComponent.prototype.ngAfterViewInit = function () {
        this.getData();
    };
    CalorieComponent.prototype.getData = function () {
        this.initialized = false;
    ...
    // events
    CalorieComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    CalorieComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
    CalorieComponent.prototype.set = function (index) {
        switch (index) {
            case 0:
    ...
    CalorieComponent.prototype.filterProcess = function () {
        this.lineChartLabels = [];
        this.lineChartData[0].data = [];
        for (var i = 0; i < this.dataScoure.label.length; i++) {
            var date = this.dataScoure.label[i];
            var bodyweight = this.dataScoure.data[0].data[i];
            var after = __WEBPACK_IMPORTED_MODULE_3_moment__(this.dateFilter.after);
            var before = __WEBPACK_IMPORTED_MODULE_3_moment__(this.dateFilter.before);
            if (__WEBPACK_IMPORTED_MODULE_3_moment__(date) >= after && __WEBPACK_IMPORTED_MODULE_3_moment__(date) <= before) {
                this.lineChartLabels.push(date);
                this.lineChartData[0].data.push(bodyweight);
            }
        }
    };
    CalorieComponent.prototype.handleError = function (error) {
        return Promise.reject(error.message || error);
    };
    CalorieComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-calorie',
            template: __webpack_require__("../../../../../src/app/calorie/calorie.component.html"),
            styles: [__webpack_require__("../../../../../src/app/calorie/calorie.component.css")]
        }),
